...
# Using lists of five and six letter words used in Scrabble, build a
# data structure of alphagrams (i.e. all letters of a word are sorted
# into alphabetical order). Use that to look up the solutions for the
# user-provided puzzle words from the daily Jumble game you typically
# find in daily newspapers (or, https://www.jumble.com/classic-jumbles).
